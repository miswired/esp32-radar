/**
 * ESP32 Microwave Motion Sensor - Stage 6: Full Diagnostics and System Integration
 *
 * This stage builds on Stage 4 and adds:
...
void setup() {
  ...
  Serial.println("\n\n");
  Serial.println("==========================================");
  Serial.println("ESP32 Microwave Motion Sensor - Stage 6");
  Serial.println("==========================================");
  Serial.println("Full Diagnostics and System Integration");
  Serial.println();
