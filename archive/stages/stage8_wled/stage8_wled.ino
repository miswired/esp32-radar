/**
 * ESP32 Microwave Motion Sensor - Stage 8: WLED Integration
 *
 * This stage builds on Stage 7 and adds:
 * - WLED integration with custom JSON payloads
 * - Send configurable JSON to WLED devices on alarm trigger
 * - Notification method refactor: checkboxes instead of dropdown
 * - Support for GET, POST, or both notification methods
 * - JSON payload validation for WLED
 * - Test WLED button in settings
 *
